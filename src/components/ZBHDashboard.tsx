...
const ZBHDashboard: React.FC = () => {
  ...
  const renderOverview = () => (
    <DashboardMetricsGrid
      distributorCount={stats.totalMDOs}
      ytdSales={stats.ytdSales.achieved * 100000}
      ytdOpeningStock={8450000}
      ytdLiquidation={10625000}
      totalOS={9480000}
      totalOverdue={1896000}
      totalBlockedParties={Math.floor(stats.totalMDOs * 0.05)}
    />
  );
  ...
  const renderRegionalPerformance = () => (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-3 gap-4">
        <button className="bg-white rounded-xl p-6 card-shadow hover:shadow-lg transition-shadow text-left">
          ...
          <h4 className="font-semibold text-gray-900 mb-1">Team Structure</h4>
          <p className="text-sm text-gray-600">View organizational chart</p>
        </button>
        ...
        <button className="bg-white rounded-xl p-6 card-shadow hover:shadow-lg transition-shadow text-left">
          ...
          <h4 className="font-semibold text-gray-900 mb-1">Set Targets</h4>
          <p className="text-sm text-gray-600">Manage zonal targets</p>
        </button>
